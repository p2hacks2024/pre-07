...
# アイデアの追加
idea1 = Ideas(title="星雲ジェネレータ", description="星雲を生成するアプリ", content="星雲を生成するアプリです", user_id=1, image="9799bd916a36b7381e1a1bf6a6ae6444.jpeg")
idea2 = Ideas(title="猫フリクター", description="食品の温度を自動調整してくれるシステム", content="食品の温度を自動調整してくれるシステムです", user_id=2)
idea3 = Ideas(title="持ち運べる扇風機", description="暑い夏を生き抜くために扇風機を持ち運べたらいいなぁ", content="持ち運び可能な扇風機です", user_id=3)
idea4 = Ideas(title='アイデアマッチング', description='アイデアをマッチングするアプリ', content='AIを使ってアイデア同士をマッチングさせて面白いアイデアになったら良いよね', user_id=3, image="1-p!nt.png-20241214144511.png")
