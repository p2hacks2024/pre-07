...
idea4 = Ideas(title="Idea 4", description="Description for idea 4", user=user1, fork=idea2.id)
idea5 = Ideas(title="Idea 5", description="Description for idea 5", user=user2, fork=idea3.id)
idea6 = Ideas(title="Idea 6", description="Description for idea 6", user=user3, fork=idea4.id)
idea7 = Ideas(title="Idea 7", description="Description for idea 7", user=user1, fork=idea5.id)
idea8 = Ideas(title="Idea 8", description="Description for idea 8", user=user2, fork=idea6.id)
session.add(idea1)
session.add(idea2)
session.add(idea3)
session.add(idea4)
